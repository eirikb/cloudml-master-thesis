...
AWS which makes it accessible from \myac{AWS} Management Console.
...
\infobox{
  \subparagraph{Driver.}
  any of the \myac{API} solutions use the term ``\emph{driver}'', it represents
...
Libcloud is an \myac{API} that aims to support the largest cloud providers through a common API. 
