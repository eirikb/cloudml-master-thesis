...
This is to distribute workload and divide \emph{cloudml-engine} into logical parts for different tasks.
...
Interaction between \texttt{user} and \texttt{Engine} is expressed in \citefig{cloudml-engine-flow} 
...
as shown in \citefig{cloudml-engine-orchestration}.
...
as expressed in \citefig{cloudml-engine-dependencies}.
...
In \citefig{cloudml-engine-dependencies} is it shown that \texttt{Kernel}
...
According to \citefig{cloudml-engine-orchestration} \texttt{Kernel} is the first module
...
The connections to providers are expressed in \citefig{cloudml-engine-flow}.
As expressed in \citefig{cloudml-engine-dependencies} \texttt{Cloud-connector}
...
This module is the last step before returning to the user, as seen in \citefig{cloudml-engine-orchestration}.
In \citefig{cloudml-engine-flow} it is expressed that \texttt{Cloud-connector} initializes
