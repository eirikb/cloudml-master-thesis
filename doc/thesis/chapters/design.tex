...
Since this single node handle both computation and storage Alice decides to 
...
Programming languages and environment considered are:
\begin{description}
...
with \myac{JSON}, its aim at web development on the cloud and its modernity.
