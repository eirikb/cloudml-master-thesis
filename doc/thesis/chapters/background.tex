...
\begin{enumerate}
  ...
  \item \emph{Develop a \myac{PIM}.}
    The next life cycle aims at using descriptions and requirements from the \myac{CIM}
    with specific technologies. \myac{OMG} standard for \myac{MDA} use \myac{UML} models,
  ...
  \item \emph{Deploy.}
    The final life cycle is based on deploying the \myac{PSM}, which concludes the five steps from
    ...
    on different systems, this without changing the \myac{PSM} from life cycle in step $3$.
\end{enumerate}
