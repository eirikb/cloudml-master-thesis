...
More about the load balancer in~\citechap{perspectives}.
...
According to the meta model~(\citefig{meta-model}) this is \texttt{build}.
The name ``build'' is a general term, while the usage in \citelist{validation-client}
