...
\begin{description} 
  \item[Ease of use.]
    ...
    Scala runs on the \myac{JVM}, which means that all the libraries and work put into Java
...
The main entry point to the application is \texttt{Engine}, this is a \emph{Scala Object} used to initialize provisioning.
...
as shown in \citefig{cloudml-engine-orchestartion}.
