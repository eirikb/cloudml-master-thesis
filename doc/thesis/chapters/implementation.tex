...
\emph{Cloudml-engine} is written in Scala, a multi-paradigm \myac{JVM} based programming language.
This language was chosen because \myac{JVM} is a popular platform, and then especially Java.
...
The logical task of \texttt{Kernel} is to map \myac{JSON} formatted strings to \texttt{Templates} including \texttt{Nodes}.
