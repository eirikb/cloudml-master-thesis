...
\begin{abstract}
  ...
  Challenges with cloud deployment are identifies in this 
  thesis through experiments, 
  performing full cloud deployments with tools offered by cloud providers.
  To tackle these challenges a model-based language (CloudML),
  is purposed to effectively eliminate these challenges
  through abstraction.
  ...
  by implementing an existing library.
  ...
  These experiments disclose the effort of this thesis.
\end{abstract}
