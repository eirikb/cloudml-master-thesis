\begin{figure}
  ...
  \begin{center}
      \begin{tikzpicture}[scale=0.6, transform shape]
        ...
        \node (CloudMLEngine) [class, rectangle split parts=3, below=of UserLibrary] {
                \textbf{CloudMLEngine}
                \nodepart{second}
                \nodepart{third}+build
          };
        ...
        \node (System) [m@rt, below=of AuxNode01] { \textbf{System} };
        \node (RuntimeInstance) [m@rt, below=of System, yshift=-1cm, label=67.5:*] { \textbf{RuntimeInstance} };
        \node (RuntimeProp) [m@rt, left=of RuntimeInstance, label=5:*] { \textbf{RuntimeProp} };
        ...
        \draw[aggregate] (System) -- (RuntimeInstance.north);
