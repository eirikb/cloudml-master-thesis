\begin{figure}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \node[box, right=of head, minimum width=3.8cm, minimum height=3.5cm, xshift=1cm, yshift=-1cm] (System) {};
      \node[box, right=of head, xshift=2cm, yshift=-0.2cm] (Engine) {Engine};
