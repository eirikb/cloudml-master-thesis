\begin{figure}[tb]
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \node[box, right=of User, minimum width=4.5cm, minimum height=3.5cm, xshift=1cm, yshift=-1cm,
        label=below:CloudML] (System) {};
      \node[box, right=of User, xshift=2.5cm, yshift=-0cm] (Engine) {Engine};
      \node[box, below=of Engine, yshift=0.5cm] (Cloud-connector) {Cloud-connector};
      \node[class, below=of Cloud-connector, yshift=0.5cm] (RuntimeInstance) {RuntimeInstance};
