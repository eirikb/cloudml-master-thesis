...
\section{Analysis}
\subsection{Amazon AWS CloudFormation}
...
\begin{table}
    ...
    \begin{tabular}{ | p{2cm} | p{2cm} | p{2.5cm} | p{2cm} | p{2cm} | p{2cm} |}
      \hline
      \textbf{Solution} & \textbf{Easy to start with} & \textbf{Business level viable} & \textbf{Model driven} & \textbf{Multicloud} \\
      \hline
     Amazon CloudFormation & No & No & No & No \\ \hline
     CA Applogic & Yes & Yes & Yes & N  \\ \hline
     Libcloud & No  & No & No & Yes \\ \hline
     jclouds & No & No & No & Yes \\ \hline
     OPA & Yes & No & No & No \\ \hline
     Whirr & No & No & No & Yes \\ \hline
     Deltacloud & No & No & No & Yes \\ \hline
     CloudML & Yes & Yes & Yes & Yes \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}
    ...
    \begin{tabular}{ | l | p{10cm} | }
      ...
      \hline
      \index{Instance} & Virtual machine instance. \\ \hline
